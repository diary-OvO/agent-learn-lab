...
func InitS09Hooks(hookBus *hooks.HookBus, checker *permission.PermissionChecker, workDir string) {
	InitS08Hooks(hookBus, checker, workDir)
}

func InitS09SubToolbox() *v2.ToolBox {
	return InitS08SubToolbox()
}

func InitS09Toolbox(subAgent *subagent.SubAgent, skillRegistry *skills.Registry) *v2.ToolBox {
